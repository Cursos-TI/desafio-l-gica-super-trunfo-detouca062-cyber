...
int main() {
    ...
    // Cálculos adicionais da carta 1
    ...
    // Cálculos adicionais da carta 2
    ...
    // Comparação de cartas (Atributos)
        // Comparação de PIB per Capita detalhada
if (pibPerCapita1 > pibPerCapita2) {
    printf("\nCarta 1 venceu no PIB per Capita!\n");
    printf("Carta 1 - %.2f reais\n", pibPerCapita1);
    printf("Carta 2 - %.2f reais\n", pibPerCapita2);
} else if (pibPerCapita2 > pibPerCapita1) {
    printf("\nCarta 2 venceu no PIB per Capita!\n");
    printf("Carta 1 - %.2f reais\n", pibPerCapita1);
    printf("Carta 2 - %.2f reais\n", pibPerCapita2);
} else {
